...
def main(complete_data_path, front_gps_data_path, middle_gps_data_path, back_gps_data_path, complete_data_sampling_rate, gps_data_sampling_rate):
    ...
    angle_between_front_and_back_gps = compute_angle_between_two_gps_data_arrays(front_utm_latitudes, front_utm_longitudes, back_utm_latitudes, back_utm_longitudes)
    angle_between_front_and_middle_gps = compute_angle_between_two_gps_data_arrays(front_utm_latitudes, front_utm_longitudes, middle_utm_latitudes, middle_utm_longitudes)
    angle_between_middle_and_back_gps = compute_angle_between_two_gps_data_arrays(middle_utm_latitudes, middle_utm_longitudes, back_utm_latitudes, back_utm_longitudes)
...
if __name__ == "__main__":
    ...
    front_gps_data_path = "MS/GPS Pipeline/data_september8th/reach-raw_202209081407.pos"
    middle_gps_data_path = "MS/GPS Pipeline/data_september8th/reach_raw_202209081406.pos"
    back_gps_data_path = "MS/GPS Pipeline/data_september8th/raw_202209081407.pos"
    complete_data_sampling_rate_in_hz = 20
    gps_data_sampling_rate_in_hz = 5

    complete_data = main(complete_data_path, front_gps_data_path, middle_gps_data_path, back_gps_data_path, complete_data_sampling_rate_in_hz, gps_data_sampling_rate_in_hz)