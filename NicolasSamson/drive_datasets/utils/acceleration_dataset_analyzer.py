...
from drive_datasets.utils.extractors import * 

from NicolasSamson.drive_datasets.utils.animate_time_constant import * 
import matplotlib.animation as animation
from matplotlib.backend_bases import KeyEvent

from drive_datasets.utils.first_order_model import *
import tqdm


class SteadyStateAnalysis():
    # 
    def __init__(self,path_2_acceleration_dataset,verbose=True,rate=0.05,n_step=40,n_window=3) -> None:
        ...
        self.path_to_folder_slip = path_2_acceleration_dataset
    ...
    def compute_time_cst_gain_delay_step_operation_points(self, df_slip,name_column_interest, name_column_cmd,freq,nb_timestamp, n_window = 3,verbose=False,produce_video_now=False,video_saving_path=""):
        ...
        if produce_video_now:
            produce_video(predictions,time_axis,cmd_of_interest_reshape,column_interest_reshape ,names=[name_column_cmd,name_column_interest],video_saving_path=video_saving_path)
    ...
    def compute_time_constant_wheel_and_body(self, df_slip,rate, nb_timestamp, verbose = True,produce_video_now = False,video_saving_path=""):
        ...
        list_column_interest = ["left_wheel_vel","right_wheel_vel","icp_vel_x" , "icp_vel_yaw" ] 
        ...
        for cmd_name, column_of_interest in tqdm.tqdm(zip(list_of_cmd_vector,list_column_interest)):
            ...
            dico_new_column = self.compute_time_cst_gain_delay_step_operation_points(df_slip_w_cmd_body,column_of_interest, cmd_name,1/rate,nb_timestamp, n_window = 3,verbose=verbose,produce_video_now=produce_video_now,video_saving_path=video_saving_path)
    ...
    def create_dataframe_for_diamond_shape_graph(self, df_slip_dataset,terrain,robot,traction,drive_params):
        ...
        dico_2_add = self.compute_time_constant_wheel_and_body(self.rate , self.n_timestamp, verbose = False,produce_video_now = False)
    ...
    def main(self,):
        ...
        #df = self.create_dataframe_for_diamond_shape_graph(self.df,params["terrain"],params["robot"],params["traction"],drive_params
        #)
        #print(df)
        #list_df.append(df)
"""
...
if __name__=="__main.py__":
    path_2_acceleration_dataset = "/home/nicolassamson/workspaces/norlab_WMRD/NicolasSamson/drive_datasets/data/warthog/wheels/grass/warthog_wheels_grass_2024_8_8_16h11s19/model_training_datasets/slip_dataset_all.pkl"

    test = "warthog_wheels_grass_2024_8_8_16h11s19"
    print(test.split())
    #SteadyStateAnalysis(path_2_acceleration_dataset,verbose=True,rate=0.05,n_step=40,n_window=3)
