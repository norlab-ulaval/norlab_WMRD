...
class TorchWMRDataset(Dataset):
    def __init__(self, csv_file, body_or_wheel_vel, training_horizon=2, steady_state_window = 160, rate=20):
        ...
        input = self.data.drop(['gt_icp_x', 'gt_icp_y', 'gt_icp_z', 'gt_icp_roll', 'gt_icp_pitch', 'gt_icp_yaw', 'calib_step'], axis=1).values
    ...
    def __getitem__(self, idx):
        return self.x_train[idx], self.y_train[idx], self.calib_step[idx]