...
train_dataset_path = '/home/dominic/repos/norlab_WMRD/data/husky/parsed_data/grass_1_torch.csv'
training_horizon = 2

wmr_dataset = TorchWMRDataset(train_dataset_path, training_horizon)

print(wmr_dataset.__len__())
